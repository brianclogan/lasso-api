...
class InventoryPricingApi
{
    ...
    {
        list($response) = $this->inventoryInventoryIdPricingGetWithHttpInfo($inventory_id);
        return $response;
    }
    ...
    {
        list($response) = $this->inventoryInventoryIdPricingPutWithHttpInfo($inventory_id, $dates);
        return $response;
    }
