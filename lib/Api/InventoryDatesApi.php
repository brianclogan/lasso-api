...
class InventoryDatesApi
{
     ...
     * @throws \CollingMedia\Lasso\ApiException on non-2xx response
     * @throws \InvalidArgumentException
     * @return array of \CollingMedia\Lasso\Model\Dates, HTTP status code, HTTP response headers (array of strings)
     */
    public function inventoryInventoryIdDatesGetWithHttpInfo($inventory_id)
    {
        $returnType = '\CollingMedia\Lasso\Model\Dates';
        $request = $this->inventoryInventoryIdDatesGetRequest($inventory_id);
            ...
            switch ($e->getCode()) {
                case 200:
                    $data = ObjectSerializer::deserialize(
                        $e->getResponseBody(),
                        '\CollingMedia\Lasso\Model\Dates',
     ...
     */
    public function inventoryInventoryIdDatesGetAsync($inventory_id)
    {
        return $this->inventoryInventoryIdDatesGetAsyncWithHttpInfo($inventory_id)
            ->then(
                function ($response) {
                    return $response[0];
                }
     ...
     * @return \GuzzleHttp\Promise\PromiseInterface
     */
    public function inventoryInventoryIdDatesGetAsyncWithHttpInfo($inventory_id)
    {
        $returnType = '\CollingMedia\Lasso\Model\Dates';
        $request = $this->inventoryInventoryIdDatesGetRequest($inventory_id);
     ...
     */
    protected function inventoryInventoryIdDatesGetRequest($inventory_id)
    {
        // verify the required parameter 'inventory_id' is set
        if ($inventory_id === null || (is_array($inventory_id) && count($inventory_id) === 0)) {
            throw new \InvalidArgumentException(
                'Missing the required parameter $inventory_id when calling inventoryInventoryIdDatesGet'
            );
        }

        $resourcePath = '/inventory/{inventoryId}/dates';
        $formParams = [];
        $queryParams = [];
        $headerParams = [];
        $httpBody = '';
     ...
     * @return array of \CollingMedia\Lasso\Model\Dates, HTTP status code, HTTP response headers (array of strings)
     */
    public function inventoryInventoryIdDatesPutWithHttpInfo($inventory_id, $dates)
    {
        $returnType = '\CollingMedia\Lasso\Model\Dates';
        $request = $this->inventoryInventoryIdDatesPutRequest($inventory_id, $dates);
     ...
     * @return \GuzzleHttp\Promise\PromiseInterface
     */
    public function inventoryInventoryIdDatesPutAsync($inventory_id, $dates)
    {
        return $this->inventoryInventoryIdDatesPutAsyncWithHttpInfo($inventory_id, $dates)
            ->then(
                function ($response) {
                    return $response[0];
                }
     ...
     * @return \GuzzleHttp\Promise\PromiseInterface
     */
    public function inventoryInventoryIdDatesPutAsyncWithHttpInfo($inventory_id, $dates)
    {
        $returnType = '\CollingMedia\Lasso\Model\Dates';
        $request = $this->inventoryInventoryIdDatesPutRequest($inventory_id, $dates);
     ...
     * @return \GuzzleHttp\Psr7\Request
     */
    protected function inventoryInventoryIdDatesPutRequest($inventory_id, $dates)
    {
        // verify the required parameter 'inventory_id' is set
        if ($inventory_id === null || (is_array($inventory_id) && count($inventory_id) === 0)) {
            throw new \InvalidArgumentException(
                'Missing the required parameter $inventory_id when calling inventoryInventoryIdDatesPut'
            );
        }
        // verify the required parameter 'dates' is set
        if ($dates === null || (is_array($dates) && count($dates) === 0)) {
            throw new \InvalidArgumentException(
                'Missing the required parameter $dates when calling inventoryInventoryIdDatesPut'
            );
        }
