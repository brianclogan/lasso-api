...
class InventoryPricingRevisionsApi
{
    ...
    {
        list($response) = $this->inventoryInventoryIdPricingRevisionsGetWithHttpInfo($inventory_id);
        return $response;
    }
    ...
    {
        list($response) = $this->inventoryInventoryIdPricingRevisionsPostWithHttpInfo($inventory_id, $dates);
        return $response;
    }
