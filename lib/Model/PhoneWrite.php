 ...
 * @link     https://github.com/colling-media/lasso-api
 */
class PhoneWrite implements ModelInterface, ArrayAccess
{
    ...
    /**
      ...
      * @var string
      */
    protected static $swaggerModelName = 'PhoneWrite';
    ...
    public function setPhone($phone)
    {
        if (!is_null($phone) && (mb_strlen($phone) > 20)) {
            throw new \InvalidArgumentException('invalid length for $phone when calling PhoneWrite., must be smaller than or equal to 20.');
        }
        if (!is_null($phone) && (mb_strlen($phone) < 1)) {
            throw new \InvalidArgumentException('invalid length for $phone when calling PhoneWrite., must be bigger than or equal to 1.');
        }
    ...
    public function setType($type)
    {
        if (!is_null($type) && (mb_strlen($type) > 25)) {
            throw new \InvalidArgumentException('invalid length for $type when calling PhoneWrite., must be smaller than or equal to 25.');
        }
        if (!is_null($type) && (mb_strlen($type) < 0)) {
            throw new \InvalidArgumentException('invalid length for $type when calling PhoneWrite., must be bigger than or equal to 0.');
        }
