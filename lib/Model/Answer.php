...
class Answer implements ModelInterface, ArrayAccess
{
     ...
     * Sets answer_id
     *
     * @param string $answer_id Specifies the answer by id. If present, `answer` will be ignored. If no answer matches `answerId` the request fails.
     *
     * @return $this
     */
     ...
     * Sets answer
     *
     * @param string $answer If no `answerId` is given, the answer will be looked-up by it's answer string. If no answer with the given answer string exists, the answer will be created.
     *
     * @return $this
     */
