 ...
 * @link     https://github.com/colling-media/lasso-api
 */
class ErrorLimitReached implements ModelInterface, ArrayAccess
{
     ...
     * @return string[]
     */
    public function getLimitedSubResourceAllowableValues()
    {
        return [
            self::LIMITED_SUB_RESOURCE_EMAIL,
            self::LIMITED_SUB_RESOURCE_PHONE,
    ...
    public function __construct(array $data = null)
    {
        ...
        $this->container['limited_sub_resource'] = isset($data['limited_sub_resource']) ? $data['limited_sub_resource'] : null;
    }
     ...
     * @return string
     */
    public function getLimitedSubResource()
    {
        return $this->container['limited_sub_resource'];
    }
    ...
    public function setLimitedSubResource($limited_sub_resource)
    {
        ...
        $this->container['limited_sub_resource'] = $limited_sub_resource;
