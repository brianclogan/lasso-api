...
/**
 * ProjectSourceType Class Doc Comment
 *
 * @category Class
 * @package CollingMedia\Lasso
 * @author   Brian Logan
 * @link     https://github.com/colling-media/lasso-api
 */
class ProjectSourceType implements ModelInterface, ArrayAccess
{
    ...
    /**
      ...
      * @var string
      */
    protected static $swaggerModelName = 'ProjectSourceType';
     ...
     * Sets source_type_id
     *
     * @param string $source_type_id source_type_id
     *
     * @return $this
     */
